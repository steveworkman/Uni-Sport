...
$item_link="http://www.sheffieldhockey.com/eventdetails.php?event_id=";
...
add_channel(
	...
	"Latest Events from SUHC",
	"SELECT name, event_id, description, eventdatetime FROM events ORDER BY eventdatetime DESC LIMIT 0,6",
	"");
